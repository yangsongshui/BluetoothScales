...
public class PregActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    private PregFragment pregFragment;
    ...
    private void initData() {
        if (pregFragment == null) {
            pregFragment = new PregFragment();
        }
        if (!pregFragment.isAdded()) {

            getSupportFragmentManager().beginTransaction().add(R.id.main_frame, pregFragment).commit();

            currentFragment = pregFragment;
        }
